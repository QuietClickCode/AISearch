...
<head>
	...
	<link href="${basePath}/resources/aisearch-admin/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/aisearch-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/aisearch-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/aisearch-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/aisearch-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/aisearch-admin/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; AISEARCH-UPMS V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>演示地址</b>：<a href="http://www.zhangshuaisearch.cn/aisearchAdmin" target="_blank">http://www.zhangshuaisearch.cn/aisearchAdmin</a></p>
...
<script src="${basePath}/resources/aisearch-admin/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/aisearch-admin/js/admin.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/aisearch-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>