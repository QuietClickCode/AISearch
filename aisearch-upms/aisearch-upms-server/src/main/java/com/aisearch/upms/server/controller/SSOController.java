package com.aisearch.upms.server.controller;
...
import com.aisearch.upms.common.constant.UpmsResult;
import com.aisearch.upms.common.constant.UpmsResultConstant;
...
/**
 * 单点登录管理
 * Created by shuaisearch on 2016/12/10.
 */
@Controller
@RequestMapping("/sso")
...
public class SSOController extends BaseController {
    ...
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "aisearch-upms-server-session-id";
    // 全局会话key列表
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "aisearch-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "aisearch-upms-server-code";
